...
const items = [
  {
    ...
    translations: {
      uz: {
        ...
        description: "9-sinfdan Seven Schoolda o'qidi va 3 yil o'tib, Harvardga kirdi. O'zbekiston xususiy maktablari orasida birinchi marta.",
      },
      ru: {
        university: 'Harvard University',
        name: 'Жасурбек Умаров',
        description: 'Учился в Seven School с 9 класса и через 3 года поступил в Гарвард. Впервые среди частных школ Узбекистана.',
      },
      en: {
        university: 'Harvard University',
        name: 'Jasurbek Umarov',
        description: 'Studied at Seven School from 9th grade and got into Harvard 3 years later. The first time among Uzbekistan\'s private schools.',
      },
    },
  },
  {
