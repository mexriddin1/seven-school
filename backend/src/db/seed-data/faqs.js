...
const items = [
  ...
  { page: 'index', sort: 5, tr: {
    uz: { q: 'Farzandimning baholarini qanday bilaman?',
          a: "Bizning <strong>Seven School</strong> mobil ilovamiz orqali farzandingizning davomati, baholari va o'zlashtirishini kuzatib borishingiz mumkin. O'zbek, rus va ingliz tillarida ishlaydi." },
    ru: { q: 'Как узнать оценки моего ребёнка?',
          a: 'Через наше мобильное приложение <strong>Seven School</strong> вы можете отслеживать посещаемость и оценки. Доступно на узбекском, русском и английском.' },
    en: { q: "How can I see my child's grades?",
          a: 'Through our <strong>Seven School</strong> mobile app you can track attendance and grades. Available in Uzbek, Russian and English.' },
  }},
  ...
  { page: 'aloqa', sort: 1, tr: {
    uz: { q: 'Qabul qaysi sinflardan boshlanadi?',
          a: "Seven Schoolga 7-sinfdan 11-sinfgacha qabul olib boriladi. Har bir sinf uchun cheklangan o'rinlar mavjud — odatda har sinfda 20 nafargacha o'quvchi." },
  ...
  { page: 'aloqa', sort: 5, tr: {
    uz: { q: "Maktabda necha o'quvchi o'qiydi?",
          a: "Hozirda Seven Schoolda 450 dan ortiq o'quvchi ta'lim olmoqda. Har bir sinfda 18–20 nafargacha o'quvchi — bu individual yondashuv uchun optimal son." },
    ru: { q: 'Сколько учеников в школе?',
          a: 'Сейчас в Seven School учатся более 450 учеников. В каждом классе 18–20 учеников — оптимально для индивидуального подхода.' },
    en: { q: 'How many students are in the school?',
          a: 'Currently 450+ students study at Seven School. Each class has 18–20 students — ideal for individual attention.' },
  }},
