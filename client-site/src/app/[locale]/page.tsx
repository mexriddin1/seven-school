      ...
      <section className="hero" id="top">
        <div className="container hero-inner">
          ...
          <h1 className="reveal delay-1">
            {s['hero.title_main']}<br />
            <span className="accent">{s['hero.title_accent']}</span> {s['hero.title_suffix']}
          </h1>
          ...
          <div className="hero-stats reveal delay-4">
            <HeroStat
              num={<><span className="cu" data-target={s['hero.stat_medals_value'] || '29'}>0</span>+</>}
              lbl={s['hero.stat_medals_label'] || 'Medal'} sub={s['hero.stat_medals_sub'] || "Birinchi yilda olimpiadalardan"} />
            <HeroStat
              num={<><span className="cu" data-target={s['hero.stat_students_value'] || '450'}>0</span></>}
              lbl={s['hero.stat_students_label'] || "O'quvchi"} sub={s['hero.stat_students_sub'] || "Hozirda bizda ta'lim olishadi"} />
            <HeroStat
              num={<><span className="cu" data-target={s['hero.stat_sports_value'] || '4'}>0</span>+</>}
              lbl={s['hero.stat_sports_label'] || 'Sport'} sub={s['hero.stat_sports_sub'] || 'Suzish, taekvondo, gimnastika, tennis'} />
            <HeroStat
              num={<>{s['hero.stat_ai_value'] || '5-sinf'}</>}
              lbl={s['hero.stat_ai_label'] || 'AI darslari'} sub={s['hero.stat_ai_sub'] || "5–7-sinflar uchun"} />
            <HeroStat
              num={<>{s['hero.stat_age_value'] || '4 yosh'}</>}
              lbl={s['hero.stat_age_label'] || 'dan'} sub={s['hero.stat_age_sub'] || "Bog'chadan 7-sinfgacha"} />
          </div>
        </div>
      </section>
