// OpenAPI 3.0 spec for Seven School backend.
...
const schemas = {
  ...
  ApplicationSubmissionInput: {
    ...
    properties: {
      ...
      age: { type: 'string', nullable: true, maxLength: 40 },
  ...
  Webhook: {
    ...
    properties: {
      ...
      selected_fields: {
        type: 'array',
        items: { type: 'string' },
        example: ['name', 'phone', 'age', 'grade', 'region', 'message', 'source_form'],
      },
  ...
  WebhookMeta: {
    ...
    properties: {
      ...
      events: { type: 'array', items: { type: 'object', properties: { key: { type: 'string' }, label: { type: 'string' } } } },
    },
  },
  WebhookTestResult: {
    type: 'object',
  ...
  GenericList: {
    type: 'object',
    properties: { items: { type: 'array', items: { $ref: '#/components/schemas/GenericRow' } } },
  },
};
  ...
  return {
    [`/api/${resource}`]: {
      ...
      post: {
        ...
        security: bearer,
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/GenericRow' } } } },
    ...
    [`/api/${resource}/{id}`]: {
      parameters: [ID_PARAM],
      get: {
        tags: [tag], summary: `Get one ${resource}`,
        responses: { 200: { description: 'OK', content: { 'application/json': { schema: { $ref: '#/components/schemas/GenericRow' } } } }, 404: notFound },
      },
      put: {
        tags: [tag], summary: `Update ${resource}`, security: bearer,
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/GenericRow' } } } },
        responses: { 200: ok, 400: validationError, 401: unauthorized, 404: notFound },
      },
      delete: {
        tags: [tag], summary: `Delete ${resource}`, security: bearer,
...
const CRUD_RESOURCES = [
  ...
  ['carousel', 'Carousel'],
  ['settings', 'Settings'],
  // Seven-school-only resources
  ['eco-stages', 'Eco Stages'],
  ['kids-features', 'Kids Features'],
  ['togaraks', 'Togaraks'],
  ['curriculum-items', 'Curriculum Items'],
...
const paths = {
  ...
  '/api/auth/login': {
    post: {
      tags: ['Auth'], summary: 'Login (returns JWT token)',
  ...
  '/api/auth/me': {
    get: {
      tags: ['Auth'], summary: 'Current user', security: bearer,
      responses: {
  ...
  '/api/auth/change-password': {
    post: {
      tags: ['Auth'], summary: 'Change current user password', security: bearer,
  ...
  '/api/users': {
    get: {
      tags: ['Users'], summary: 'List admin users', security: bearer,
      responses: { 200: { description: 'OK', content: { 'application/json': { schema: { type: 'object', properties: { items: { type: 'array', items: { $ref: '#/components/schemas/AdminUser' } } } } } } }, 401: unauthorized },
    },
    post: {
      tags: ['Users'], summary: 'Create admin user', security: bearer,
  ...
  '/api/users/{id}': {
    parameters: [ID_PARAM],
    get: {
      tags: ['Users'], security: bearer, summary: 'Get admin user',
    ...
    put: {
      tags: ['Users'], security: bearer, summary: 'Update admin user',
      requestBody: { required: true, content: { 'application/json': { schema: {
        type: 'object',
        properties: {
          email: { type: 'string', format: 'email' },
    ...
    delete: {
      tags: ['Users'], security: bearer, summary: 'Delete admin user',
      responses: { 200: noContent, 401: unauthorized, 404: notFound },
    },
  },
  ...
  '/api/upload': {
    post: {
      tags: ['Upload'], summary: 'Upload one file (multipart/form-data, field: file)', security: bearer,
      requestBody: { required: true, content: { 'multipart/form-data': { schema: {
        type: 'object',
        properties: { file: { type: 'string', format: 'binary' }, alt_text: { type: 'string' } },
      } } } },
      responses: { 201: { description: 'OK', content: { 'application/json': { schema: { $ref: '#/components/schemas/UploadResponse' } } } }, 401: unauthorized },
    },
  },
  '/api/media': {
    get: {
      tags: ['Media'], summary: 'List uploaded media', security: bearer,
      responses: { 200: { description: 'OK', content: { 'application/json': { schema: { type: 'object', properties: { items: { type: 'array', items: { $ref: '#/components/schemas/MediaItem' } } } } } } }, 401: unauthorized },
    },
  },
  '/api/media/{id}': {
    parameters: [ID_PARAM],
    delete: { tags: ['Media'], security: bearer, summary: 'Delete media', responses: { 200: noContent, 401: unauthorized, 404: notFound } },
  },

  '/api/public-site': {
    get: {
      tags: ['Public Site'], summary: 'Get the whole site bundle for one locale (public)',
      parameters: [{ name: 'locale', in: 'query', schema: { type: 'string', enum: ['uz', 'ru', 'en'], default: 'uz' } }],
  ...
  '/api/applications': {
    post: {
      tags: ['Applications'], summary: 'Public form submission (creates a lead, triggers email + webhooks)',
    ...
    get: {
      tags: ['Applications'], summary: 'List submissions (admin inbox)', security: bearer,
      parameters: [{ name: 'status', in: 'query', schema: { type: 'string', enum: ['new', 'contacted', 'closed'] } }],
      responses: {
  ...
  '/api/applications/{id}': {
    parameters: [ID_PARAM],
    get: {
      tags: ['Applications'], security: bearer, summary: 'Get one submission',
    ...
    put: {
      tags: ['Applications'], security: bearer, summary: 'Update submission (status / notes)',
      requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/ApplicationUpdate' } } } },
      responses: { 200: ok, 400: validationError, 401: unauthorized, 404: notFound },
    },
    delete: {
      tags: ['Applications'], security: bearer, summary: 'Delete submission',
      responses: { 200: noContent, 401: unauthorized, 404: notFound },
    },
  },
  ...
  '/api/webhooks/meta': {
    get: {
      tags: ['Webhooks'], summary: 'Available fields and events for webhook configuration', security: bearer,
      responses: { 200: { description: 'OK', content: { 'application/json': { schema: { $ref: '#/components/schemas/WebhookMeta' } } } }, 401: unauthorized },
    },
  },
  '/api/webhooks': {
    get: {
      tags: ['Webhooks'], summary: 'List webhooks (default: active; ?archived=1 for archived)', security: bearer,
    ...
    post: {
      tags: ['Webhooks'], summary: 'Create webhook', security: bearer,
  ...
  '/api/webhooks/{id}': {
    parameters: [ID_PARAM],
    get: { tags: ['Webhooks'], summary: 'Get one webhook', security: bearer, responses: { 200: { description: 'OK', content: { 'application/json': { schema: { $ref: '#/components/schemas/Webhook' } } } }, 401: unauthorized, 404: notFound } },
    put: {
      tags: ['Webhooks'], summary: 'Update webhook (partial)', security: bearer,
      requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/WebhookInput' } } } },
      responses: { 200: ok, 400: validationError, 401: unauthorized, 404: notFound },
    },
    delete: { tags: ['Webhooks'], summary: 'Hard-delete webhook (cascades deliveries)', security: bearer, responses: { 200: noContent, 401: unauthorized, 404: notFound } },
  },
  '/api/webhooks/{id}/archive': {
    parameters: [ID_PARAM],
    post: { tags: ['Webhooks'], summary: 'Archive (soft-delete) a webhook', security: bearer, responses: { 200: ok, 401: unauthorized, 404: notFound } },
  },
  '/api/webhooks/{id}/restore': {
    parameters: [ID_PARAM],
    post: { tags: ['Webhooks'], summary: 'Restore an archived webhook', security: bearer, responses: { 200: ok, 401: unauthorized, 404: notFound } },
  },
  '/api/webhooks/{id}/test': {
    parameters: [ID_PARAM],
    post: {
      tags: ['Webhooks'], summary: 'Send a sample payload to the webhook URL using current saved config', security: bearer,
      responses: { 200: { description: 'Delivery result', content: { 'application/json': { schema: { $ref: '#/components/schemas/WebhookTestResult' } } } }, 401: unauthorized, 404: notFound },
    },
  },
  '/api/webhooks/{id}/deliveries': {
    parameters: [ID_PARAM],
    get: {
      tags: ['Webhooks'], summary: 'Recent delivery attempts for a webhook', security: bearer,
  ...
  '/api/webhooks/{id}/deliveries/{deliveryId}': {
    ...
    get: {
      tags: ['Webhooks'], summary: 'Full body of one delivery (request + response)', security: bearer,
      responses: {
...
export const openapiSpec = {
  openapi: '3.0.3',
  info: {
    title: 'Seven School API',
    version: '1.0.0',
    description:
      'REST API for Seven School. Public endpoints (no auth) feed the public site; /api/applications POST creates a lead and triggers email + multi-webhook delivery. Admin endpoints require Bearer JWT.',
  },
  servers: [
