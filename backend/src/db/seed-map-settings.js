...
const settings = [
  { key: 'contact.map_lat', value_raw: '', description: 'Google Map latitude. Example: 41.3265' },
  { key: 'contact.map_lng', value_raw: '', description: 'Google Map longitude. Example: 69.2848' },
