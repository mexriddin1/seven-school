    ...
    translations: {
      uz: {
        ...
        meta: [
          ...
          { label: 'Yutuqlar', value: 'Davlat test markazi matematika eksperti (2009–2013), "Abituriyent testlar to\'plami. Matematika" kitobi muallifi, Seven School matematika darsliklari muallifi' },
  ...
  },
  {
    ...
    translations: {
      ...
      ru: {
        ...
        bio: '<p>Возглавляет направление математики в Seven School. Учит не только формулам, но и формирует у учеников математическое мышление.</p><p>Определяет, где у ученика проблема, и работает именно с этой точкой. Даёт сильную теоретическую и практическую подготовку к международным экзаменам и олимпиадам.</p>',
        meta: [{ label: 'Специализация', value: 'Математика, подготовка к международным олимпиадам' }],
      },
      en: {
        name: 'Asqarov Shomirza',
        role: 'Lead Mathematics Teacher',
        bio: '<p>Leads the math department at Seven School. He doesn\'t just teach formulas — he builds mathematical thinking in students.</p><p>He pinpoints exactly where each student struggles and works from there. Provides strong theoretical and practical preparation for international exams and olympiads.</p>',
