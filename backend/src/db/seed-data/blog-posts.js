...
const posts = [
  {
    ...
    tr: {
      uz: {
        ...
        content: '<p>Bu o\'quvchimiz <strong>Islom Barotaliyev</strong> — <strong>$252,000</strong> grant sohibi. O\'zbek so\'mida qancha bo\'ladi bilasizmi? Taxminan <strong>3 milliard 150 million so\'m</strong>.</p><p>Maktabni hali tamomlamadi, lekin ko\'rib turganingizdek TOP universitetlarga qabul qilindi. Qoyil-e! Bir emas, <strong>ikki universitetdan grant!</strong></p><h2>Islom haqida</h2><ul><li>2024-yildan buyon Seven Schoolda tahsil oladi</li><li>Akademik ko\'rsatkichlari: <strong>IELTS 7.5</strong> va <strong>SAT 1410</strong></li><li>Ikki TOP universitetdan grant olgan</li><li>Grant summasi: <strong>$252,000</strong></li></ul><p>Seven School — biz ilmga sodiqmiz, biz sizga sodiqmiz!</p>',
      },
      ru: {
        ...
        content: '<p>Наш ученик <strong>Ислом Бароталиев</strong> — обладатель гранта в <strong>$252,000</strong> (около <strong>3 млрд 150 млн сумов</strong>).</p><p>Он ещё не окончил школу, но уже принят в TOP-университеты. И не в один, а сразу <strong>в два — оба с грантом!</strong></p><h2>Об Исломе</h2><ul><li>Учится в Seven School с 2024 года</li><li>IELTS 7.5, SAT 1410</li><li>Грант от двух TOP-университетов</li><li>Сумма гранта: <strong>$252,000</strong></li></ul><p>Seven School — мы преданы знаниям, мы преданы вам!</p>',
      },
      en: {
        badge: 'Grant', date_label: '2026',
  ...
  },
  {
    ...
    tr: {
      uz: { badge: 'Tavsiya', date_label: '22 Yanvar, 2026',
        ...
        content: '<p>Jasurbek Umarov — Seven School bitiruvchisi, <strong>$394,000</strong> grant bilan Harvard ga qabul qilingan.</p>',
      },
      ru: { badge: 'Совет', date_label: '22 января 2026',
        ...
        content: '<p>Жасурбек Умаров — выпускник Seven School, поступил в Harvard с грантом <strong>$394,000</strong>.</p>',
      },
      en: { badge: 'Advice', date_label: 'January 22, 2026',
        ...
        content: '<p>Jasurbek Umarov — a Seven School graduate, admitted to Harvard with a <strong>$394,000</strong> grant.</p>',
      },
    },
  },
  {
